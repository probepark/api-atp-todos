...
import com.apt.todos.config.LOGIN_REGEX
...
import com.apt.todos.web.rest.errors.BadRequestAlertException
...
class UserResource(
    ...
    @PreAuthorize("hasAuthority(\"$ADMIN\")")
    fun getAuthorities(): Mono<List<String>> = userService.getAuthorities().collectList()
