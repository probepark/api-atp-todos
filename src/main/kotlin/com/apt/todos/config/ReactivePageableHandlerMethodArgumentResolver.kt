...
constructor(
    ...
    override fun supportsParameter(parameter: MethodParameter): Boolean =
        Pageable::class.java == parameter.parameterType
     ...
     */
    fun isFallbackPageable(pageable: Pageable) =
        if (fallbackPageable == null) false else fallbackPageable == pageable
    ...
    private fun getPageable(
        ...
        @Nullable pageString: String?,
        @Nullable pageSizeString: String?
    ): Pageable {
    ...
    companion object {
        ...
        private const val INVALID_DEFAULT_PAGE_SIZE =
        ...
        private fun getDefaultPageRequestFrom(parameter: MethodParameter, defaults: PageableDefault): Pageable {
            ...
            return if (defaults.sort.isEmpty()) {
                ...
                PageRequest.of(defaultPageNumber, defaultPageSize, defaults.direction, *defaults.sort)
            }
        }

        fun assertPageableUniqueness(parameter: MethodParameter) {
            val method = parameter.method
                ?: throw IllegalArgumentException("Method parameter $parameter is not backed by a method.")
